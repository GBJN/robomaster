...
#define NORMAL_TIME_2 450000
#define NORMAL_TIME_3 1000000


#define REMOTE_SWITCH_CHANGE_1TO3TO1TO3			(uint8_t)((STICK_UP << 6) | (STICK_CENTRAL << 4) | (STICK_UP << 2) | STICK_CENTRAL)
#define REMOTE_SWITCH_CHANGE_1TO3TO2TO3			(uint8_t)((STICK_UP << 6) | (STICK_CENTRAL << 4) | (STICK_DOWN << 2) | STICK_CENTRAL)
#define REMOTE_SWITCH_CHANGE_2TO3TO2TO3			(uint8_t)((STICK_DOWN << 6) | (STICK_CENTRAL << 4) | (STICK_DOWN << 2) | STICK_CENTRAL)
#define REMOTE_SWITCH_CHANGE_2TO3TO1TO3			(uint8_t)((STICK_DOWN << 6) | (STICK_CENTRAL << 4) | (STICK_UP << 2) | STICK_CENTRAL)
#define REMOTE_SWITCH_CHANGE_3TO2TO3TO2			(uint8_t)((STICK_CENTRAL << 6) | (STICK_DOWN << 4) | (STICK_CENTRAL << 2) | STICK_DOWN)
#define REMOTE_SWITCH_CHANGE_3TO2TO3TO1			(uint8_t)((STICK_CENTRAL << 6) | (STICK_DOWN << 4) | (STICK_CENTRAL << 2) | STICK_UP)
#define REMOTE_SWITCH_CHANGE_3TO1TO3TO1			(uint8_t)((STICK_CENTRAL << 6) | (STICK_UP << 4) | (STICK_CENTRAL << 2) | STICK_UP)
#define REMOTE_SWITCH_CHANGE_3TO1TO3TO2			(uint8_t)((STICK_CENTRAL << 6) | (STICK_UP << 4) | (STICK_CENTRAL << 2) | STICK_DOWN)
//动三下改状态
